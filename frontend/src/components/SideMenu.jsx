...
const categoryMenuOptions = [
  {
    ...
    subcategories: [
      ...
      {
        name: "Paper Products",
        link: "/categories/office-supplies/paper-products",
      },
    ],
  },
  {
    ...
    subcategories: [
      ...
      { name: "Switches", link: "/categories/electrical/switches" },
      {
        ...
        link: "/categories/electrical/circuit-breakers",
      },
    ],
  },
  {
    ...
    subcategories: [
      ...
      {
        name: "Motor Drives",
        link: "/categories/industrial-automation/motor-drives",
      },
      {
        name: "SCADA Systems",
        link: "/categories/industrial-automation/scada-systems",
      },
    ],
  },
  {
    ...
    subcategories: [
      ...
      {
        name: "Pallet Jacks",
        link: "/categories/material-handling/pallet-jacks",
      },
    ],
  },
  {
    ...
    subcategories: [
      ...
      { name: "Saws", link: "/categories/power-tools/saws" },
      {
        ...
        link: "/categories/power-tools/impact-wrenches",
      },
    ],
  },
  {
    ...
    subcategories: [
      { name: "Office Chairs", link: "/categories/furniture/office-chairs" },
      {
        ...
        link: "/categories/furniture/cafeteria-tables",
      },
      {
        name: "Service Trolleys",
        link: "/categories/furniture/service-trolleys",
      },
    ],
  },
  {
    ...
    subcategories: [
      ...
      { name: "Mops & Buckets", link: "/categories/cleaning/mops-buckets" },
      {
        ...
        link: "/categories/cleaning/cleaning-chemicals",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    subcategories: [
      {
        name: "Multimeters",
        link: "/categories/testing-instruments/multimeters",
      },
      { name: "Calipers", link: "/categories/testing-instruments/calipers" },
      {
        name: "Thermometers",
        link: "/categories/testing-instruments/thermometers",
      },
    ],
  },
  {
    ...
    subcategories: [
      ...
      { name: "Garden Tools", link: "/categories/agriculture/garden-tools" },
      {
        ...
        link: "/categories/agriculture/irrigation-equipment",
      },
    ],
  },
  {
    ...
    subcategories: [
      {
        ...
        link: "/categories/pumps/centrifugal-pumps",
      },
      {
        name: "Submersible Pumps",
        link: "/categories/pumps/submersible-pumps",
      },
...
function SideMenu({ showSideMenu, setShowSideMenu ,menu}) {
  ...
  return (
    <>
      ...
      md:relative md:translate-x-0 md:flex md:w-fit md:h-[80vh]  md:top-auto md:left-auto
    ...
    `}
        >
          ...
          {isSubcategoryPage ? (
            ...
            <div className="md:w-80 bg-white shadow-md rounded-lg p-4 overflow-y-auto  h-full">
