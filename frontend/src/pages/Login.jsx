        ...
        {!showForgotPassword ? (
            ...
            <div className="flex flex-col flex-1 justify-center gap-6">
              <div className="flex flex-col gap-6">
                ...
                <div className="flex flex-row justify-between flex-wrap">
                  <p onClick={() => setShowForgotPassword(true)} className="!text-xs !text-blue-500 cursor-pointer transition-transform duration-200 hover:scale-105">
                    Forgot Password ?
                  </p>
                  <button
                    onClick={handleLogin}
              ...
              <button
                ...
                className="bg-white !text-sm border-1 border-gray-200 rounded-sm shadow-md px-2 py-2 items-center flex flex-row gap-4 justify-center transition-transform duration-200 hover:scale-105"
              >
                <svg
              ...
              <p className="!text-xs text-center transition-transform duration-200 hover:scale-105">
          ...
          <div className="md:w-2/5 h-full py-8 md:py-10 px-8 flex flex-col">
            <div className="flex flex-col gap-1 md:m-0 mb-4">
              ...
              <p className="!text-sm !text-gray-500">Enter your registered email and we will send you a reset link!</p>
            </div>

            <div className="flex flex-col flex-1 justify-center gap-6">
              {!mailSend? <div className="flex flex-col gap-6">
                <div className="flex flex-col gap-1">
                  <label className="!text-sm !text-gray-600">Registered Email :</label>
                  <input
                    type="email"
                    placeholder="Enter email"
                ...
                <p className="!text-xs md:!text-sm !text-green-800 font-semibold">Reset mail has been sent to {forgotPasswordEmail}. Please check your mail.</p>
