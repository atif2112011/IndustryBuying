...
function Certification(){
    return<div class="px-12 md:px-22 py-12">
  <h2 class="!text-xl md:!text-3xl !font-bold !text-center !text-blue-900 mb-12">Our Certifications</h2>

  {/* <!-- Certification 1 --> */}
  <div class="flex flex-col md:flex-row items-center mb-16">
    <div class="md:w-1/2 mb-6 md:mb-0">
      <h3 class="!text-md md:!text-xl !font-semibold !text-blue-800">ISO 9001:2015 Certified</h3>
  ...
  <div class="flex flex-col md:flex-row-reverse items-center mb-16">
    <div class="md:w-1/2 mb-6 md:mb-0">
      <h3 class="!text-md md!text-xl !font-semibold !text-blue-800">FDA Registered Facility</h3>
      <p class="mt-4 !text-sm md:!text-md !text-gray-700">
  ...
  <div class="flex flex-col md:flex-row items-center mb-16">
    <div class="md:w-1/2 mb-6 md:mb-0">
      <h3 class="!text-md md!text-xl !font-semibold !text-blue-800">GMP Compliant</h3>
      <p class="mt-4 !text-sm md:!text-md !text-gray-700">
