...
return <div className="flex flex-col w-full h-screen items-center p-4 px-8 mt-4">
    {/* Search Area */}
    ...
    <h2 className="!text-4xl !font-medium text-center">How can we help you ?</h2>
    ...
    {/* Main Div */}
    <div className="flex flex-row rounded-md flex-1 gap-4 items-start w-full pt-6">
